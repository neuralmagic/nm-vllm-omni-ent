...
| PR label `build-omni` | [Omni release](../../actions/workflows/omni-release.yml) — full pipeline + commit status on PR |
...
- **Midstream workflows** — `omni-release.yml` (tag, PR label, manual), `midstream-build.yml` (deprecated)
