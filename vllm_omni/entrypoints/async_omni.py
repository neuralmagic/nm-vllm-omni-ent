    ...
    async def _process_orchestrator_results(
        ...
        while True:
            ...
            if output_to_yield:
                ...
                _outs = getattr(output_to_yield, "outputs", None) or []
                _mm = getattr(output_to_yield, "multimodal_output", None)
        ...
        async def _final_output_loop():
            ...
            try:
                while True:
                    ...
                    _eo = getattr(msg, "engine_outputs", None)
                    _mm = getattr(_eo, "multimodal_output", None) if _eo else None
